---
description: Beginner-friendly guide to creating BetterSEQTA+ plugins.
---
...
- [themes](https://github.com/BetterSEQTA/BetterSEQTA-Plus/blob/main/src/plugins/built-in/themes/index.ts): Shows how to change SEQTA's appearance
- [notificationCollector](https://github.com/BetterSEQTA/BetterSEQTA-Plus/blob/main/src/plugins/built-in/notificationCollector/index.ts): Shows how to work with SEQTA's notifications
- [timetable](https://github.com/BetterSEQTA/BetterSEQTA-Plus/blob/main/src/plugins/built-in/timetable/index.ts): Shows how to modify SEQTA's timetable view
- [assessmentsAverage](https://github.com/BetterSEQTA/BetterSEQTA-Plus/blob/main/src/plugins/built-in/assessmentsAverage/index.ts): Shows how to add new features to existing pages
...
- Check out the built-in plugins in the [`src/plugins/built-in` folder on GitHub](https://github.com/BetterSEQTA/BetterSEQTA-Plus/tree/main/src/plugins/built-in)
- Open an issue on our [GitHub page](https://github.com/BetterSEQTA/BetterSEQTA-Plus/issues)

Happy coding and feel free to checkout the api reference [here](plugin-api.md)
